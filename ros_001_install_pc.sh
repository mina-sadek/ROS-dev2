...
if [ -d "$home_dir/catkin_ws/src/ros_001" ]; then
...
# download and extract the ros_001 folder into the catkin_ws/src
echo "Downloading ros_001 into $home_dir/catkin_ws/src"
...
echo "rebuilding the catkin_ws workspace"
cd $home_dir/catkin_ws
catkin_make

echo "Done installing ros_001 at location: $home_dir/catkin_ws/src/ros_001"
echo "===================================="
